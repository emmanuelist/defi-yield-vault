...
const HowItWorksSection: React.FC = () => {
    ...
    const steps = [
        {
            id: 'deposit',
            title: 'Secure Bitcoin Deposit',
            description: 'Connect your wallet and deposit your Bitcoin into our non-custodial vault system. Your assets remain fully sovereign while benefiting from institutional-grade security protocols.',
            icon: <Wallet size={28} />,
            color: '#F7931A',
        ...
        {
            id: 'strategy',
            title: 'Yield Strategy Allocation',
            description: 'Your Bitcoin is automatically allocated across diversified DeFi strategies, maximizing returns while maintaining optimal risk parameters tailored to market conditions.',
                ...
                <div className="relative w-full h-full">
                    <div className="absolute inset-0 flex items-center justify-center">
                        <svg width="100%" height="100%" viewBox="0 0 300 180" className="overflow-visible">
                            ...
                            <text x="150" y="95" textAnchor="middle" className="dark:fill-[#F7931A] fill-[#F7931A] font-bold text-xs">sBTC</text>
                            ...
                            {[0, 1, 2, 3, 4].map((i, index) => {
                                ...
                                return (
                                    <g key={`strategy-${i}`}>
                                        ...
                                        <circle cx={x} cy={y} r="14" className={`dark:fill-slate-900/80 fill-slate-50/80 strategy-platform-${i}`} filter="url(#strategyBlur)" />
                                        <text x={x} y={y + 4} textAnchor="middle" className="dark:fill-slate-400 fill-slate-600 text-[8px]">DeFi-{i + 1}</text>
                                        ...
                                        <circle className={`strategy-particle-${i}`} r="2" fill="#6366F1" filter="url(#strategyBlur)" />
                                    </g>
                                );
                            })}
                            ...
                            {[0, 1, 2, 3, 4].map((i, index) => {
                                ...
                                const percentage = [30, 25, 20, 15, 10][index];
        ...
        },
        {
            ...
            description: 'Earned yield is automatically reinvested to maximize your returns through the power of compounding, eliminating manual reinvestment and optimizing gas costs.',
            icon: <Zap size={28} />,
            color: '#10B981',
                        ...
                        <svg width="100%" height="100%" viewBox="0 0 300 180" className="overflow-visible">
                            ...
                            {[0, 1, 2].map((i) => (
                                <g key={`time-${i}`} className={`time-indicator-${i}`}>
                                    <text x={120 + i * 30} cy={140} y="150" textAnchor="middle" className="dark:fill-slate-400 fill-slate-600 text-[8px]">Month {i + 1}</text>
                                </g>
                            ))}
                        </svg>
                    </div>
        ...
        },
        {
            ...
            description: 'Access your Bitcoin and earned yield at any time with no lock periods. Withdraw directly to your wallet with complete control over your assets.',
    ...
    return (
        ...
        >
            ...
            {/* <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-96 h-96 rounded-full dark:bg-purple-500/5 bg-purple-500/3 blur-3xl"></div>
                <div className="absolute bottom-0 left-0 translate-y-1/3 -translate-x-1/4 w-96 h-96 rounded-full dark:bg-[#F7931A]/5 bg-[#F7931A]/3 blur-3xl"></div>
            </div> */}
            <div className="absolute inset-0 pointer-events-none">
                {/* Dot pattern */}
                <div className="absolute inset-0 dark:bg-grid-slate-700/[0.03] bg-grid-slate-300/[0.07] bg-[size:20px_20px] opacity-40"></div>
            ...
            <div className="container mx-auto px-4 relative z-10 max-w-6xl">
                ...
                <div className="text-center max-w-2xl mx-auto mb-8">
                    <h2 className="text-2xl md:text-3xl font-bold mb-3 dark:text-white text-slate-800 group">
                        How sBTC Yield Vault <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#F7931A] to-amber-500">Works</span>
                    ...
                    <p className="dark:text-slate-300 text-slate-600 text-sm md:text-base">
                        Generate optimized yield on your Bitcoin through a secure, automated process—no technical knowledge required.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-10 gap-6 mt-6">
                    ...
                    {/* <div className="lg:col-span-3 flex flex-col">
                        {steps.map((step, index) => (
                            <motion.button
                                ...
                                className={`mb-4 text-left flex items-start px-4 py-3.5 rounded-xl transition-all duration-300 ${activeStep === index
                                    ? `bg-gradient-to-r ${step.gradient} ${step.accent} dark:bg-opacity-20 bg-opacity-90 shadow-md`
                                    : 'dark:bg-slate-800/40 dark:hover:bg-slate-800/60 dark:border-slate-700/50 bg-white/70 hover:bg-white border-slate-200 hover:border-slate-300 border'
                                    }`}
                                whileHover={{ x: 4 }}
                                whileTap={{ scale: 0.98 }}
                            >
                                <div className="flex-shrink-0 mt-0.5">
                                    <div
                                        className={`h-8 w-8 rounded-lg flex items-center justify-center ${activeStep === index
                                            ? 'bg-gradient-to-br from-white/10 to-white/5 dark:shadow-inner shadow-inner'
                    ...
                    <div className="lg:col-span-7">
                        <div className="relative h-96 rounded-xl overflow-hidden border dark:border-slate-800 border-slate-200 dark:bg-slate-800/50 bg-white/50 backdrop-blur-sm">
                            ...
                            {/* <div className="absolute top-0 left-0 right-0 h-1 dark:bg-slate-700 bg-slate-200">
                                <motion.div
                                    className="h-full"
                                    style={{ background: steps[activeStep].color }}
                                    initial={{ width: '0%' }}

                ...
                >
                    ...
                    <div className={`border-b ${borderColor} p-4 flex justify-between items-center bg-gradient-to-r ${headerBg}`}>
                        <div className="flex items-center">
                            <SBTCYieldVaultLogo iconOnly className="mr-8 h-4 w-4" />
                        ...
                        <AnimatePresence mode="wait">
                            {connectionStep === "select" && (
                                ...
                                >
                                    <p className={`${subtextColor} text-xs mb-4`}>
                                        Connect your wallet to access the sBTC Yield Vault and start earning yield on your Bitcoin.
                                    </p>
                            ...
                            {connectionStep === "connected" && selectedWallet && (
                                ...
                                >
                                    ...
                                    <p className={`${subtextColor} text-xs text-center mb-5`}>
                                        Your wallet is now connected to the sBTC Yield Vault.
                                    </p>
                    ...
                    {connectionStep === "select" && (
                        <div className={`p-3 border-t ${borderColor} ${footerBg} text-center`}>
                            <p className="text-xs text-slate-500">
                                By connecting a wallet, you agree to the sBTC Yield Vault Terms of Service and Privacy Policy.
                            </p>
                        </div>
                    )}
                </motion.div>
